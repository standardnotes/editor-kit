  ...
  _createClass(ComponentManager, [{
    ...
    value: function _performSavingOfItems(_ref) {
      var items = _ref.items,
          ...
          callback = _ref.callback; // presave block allows client to gain the benefit of performing something in the debounce cycle.
    ...
    */
    ...
    value: function saveItems(items, callback) {
      ...
      var skipDebouncer = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      var presave = arguments[3]; // We need to make sure that when we clear a pending save timeout,
