  ...
  connectToBridge() {
    ...
    this.componentRelay.streamContextItem(note => {
      ...
      if (this.delegate.onNoteLockToggle) {
        var _getItemAppDataValue;

        const isLocked = (_getItemAppDataValue = this.componentRelay.getItemAppDataValue(note, 'locked')) !== null && _getItemAppDataValue !== void 0 ? _getItemAppDataValue : false;
